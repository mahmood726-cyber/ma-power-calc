        # Ma Power Calc: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/ma-power-calc.git

        ## Objective

        MAPowerCalc is a comprehensive meta-analysis power and sample-size calculator supporting 15 effect-size types, heterogeneity modelling, and sequential analysis designs.
        ...
        - Code: https://github.com/mahmood726-cyber/ma-power-calc.git
